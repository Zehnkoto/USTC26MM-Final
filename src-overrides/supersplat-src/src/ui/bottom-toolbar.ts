...
import handGrabSvg from './svg/hand-grab.svg';
...
class BottomToolbar extends Container {
    constructor(events: Events, tooltips: Tooltips, args = {}) {
        ...
        const physicsDrag = new Button({
            id: 'bottom-toolbar-physics-drag',
            class: 'bottom-toolbar-tool'
        });
        ...
        physicsDrag.dom.appendChild(createSvg(handGrabSvg));
        ...
        physicsDrag.dom.addEventListener('click', () => events.fire('physics.dragImpulsePreview'));
        ...
        events.on('tool.activated', (toolName: string) => {
            ...
            physicsDrag.class[toolName === 'physicsDragImpulse' ? 'add' : 'remove']('active');
        ...
        tooltips.register(physicsDrag, '物理抓取预览：按住 Gaussian，像手掌一样拖动对应 proxy');
