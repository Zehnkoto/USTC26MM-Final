...
class RightToolbar extends Container {
    constructor(events: Events, tooltips: Tooltips, args = {}) {
        ...
        const physicsPanel = new Button({
            id: 'right-toolbar-physics-panel',
            class: 'right-toolbar-toggle',
            icon: 'E136'
        });
        ...
        tooltips.register(physicsPanel, 'Physics simulation', 'left');
        ...
        physicsPanel.on('click', () => events.fire('physicsPanel.toggleVisible'));
        ...
        events.on('physicsPanel.visible', (visible: boolean) => {
            physicsPanel.class[visible ? 'add' : 'remove']('active');
        });
